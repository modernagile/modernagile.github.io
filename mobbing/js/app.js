...
var mode = null;
var prevMode = null;
var directLink = "https://docs.google.com/document/d/1Ve5LVAJvGqJbUZR6C2o3ZNvFPKpuJ6sfIwxlpgKpKCk/export?format=pdf";
...
function addBubble() {
	...
	if(mode == "portrait") {
		...
		bubble.style.marginLeft = -bubbleWidth/2+'px';
	}
	else {
...
function showBubble() {
	...
	if(mode == "portrait") {
		...
		bubble.style.top = wheelDiameter + 200 + 30 + 'px';
	}
	else {
...
function autoDownload() {
	...
	ifrm.setAttribute('id', 'auto-download'); // assign an id
  document.body.appendChild(ifrm); // to place at end of document
	ifrm.setAttribute('src', directLink);
}
